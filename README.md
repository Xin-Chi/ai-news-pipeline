...
第三方維護的非官方鏡像(`tim-hilde.github.io/anthropic-rss`)。這代表:
內容真實性無法 100% 保證(理論上有被竄改或延遲更新的風險,雖然機率低);
維護者若停止更新或該網址失效,這個來源會直接掛掉,而且不會有官方替代方案
可以馬上換。目前接受這個取捨,因為 Anthropic 官方確實沒有更好的替代管道。
